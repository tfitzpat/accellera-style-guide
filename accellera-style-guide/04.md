...
All pages except the cover page are mandatory. The page numbers of the abstract, notice and participants page shall use Western Arabic numerals (1, 2, 3, etc.). The cover and title page do not have page numbers. Frontmatter pages do not contain a header.
