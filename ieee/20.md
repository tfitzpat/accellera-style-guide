...
Exceptions may be made for numbering established in previously published amendments. Exceptions shall only be valid until a revision occurs, after which the numbering described in [Clause 13](13.html) will be implemented. [Table 3](#pdxgdgi) shows appropriate numbering formats that may be used for amendments and corrigenda. (See Annex C for examples of amendment numbering.)
...
<tbody>
  ...
  <tr>
   ...
   reference="pdxgdgi"
   caption="Table 3&mdash;Numbering of amended material"
   alt-text=""
