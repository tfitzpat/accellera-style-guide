...
Please note the distinction of the scope from the purpose of the standard discussed in [12.2.4](#12.2.4).
...
Please note the distinction of the purpose from the scope of the standard discussed in [12.2.3](#12.2.3).

### 12.2.5 Word usage
{:#12.2.5}

Include the definitions of “*shall*,” “*should*,” and “*may*” within a draft standard. The subclause appears in Clause 1 Overview of the draft. See [12.2.2](#12.2.2) and the example of a draft standard in Annex B for more information.
...
Normative references may include the following:
  ...
  2. {:#12-3-1-b}**Non-standards documents:** A document that is not a standard may be cited provided that:
  ...
  3. {:#12-3-1-c}**Draft standards:** Unpublished drafts may be used as normative references as long as they are:
    * Dated
    * Readily available
    * Retrievable
...
First, remember ALL drafts included in the Normative References shall be numbered and dated [see [item c) in 12.3.1](#12-3-1-c)]. Similarly, ALL non-standards references shall be dated [see [item b) in 12.3.1](#12-3-1-b)].
