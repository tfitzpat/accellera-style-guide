...
[Table 1](#ghzcmjn) lists a number of functions and operators that are set in upright (Roman) text.
...
| exp (exponential) | max (maximum)   | var (variance) |"
   caption="Table 1&mdash;Examples of functions and operators set in upright (Roman) text"
   alt-text=""
   class="fixed"
