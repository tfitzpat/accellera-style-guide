...
Letter symbols defined in applicable IEEE standards (see [Clause 2](02.html)) should be used in preparing mathematical expressions. (See [14.4](14.html#14-4) for a discussion of letter symbols.)
...
$$E_0=\frac{\sum_{i=1}^N E_j}{N}$$

where

> $$E_0$$ is the dc value of the waveform
>
> $$N$$ is the number of sample data in one period
>
> $$E_j$$ is the $$i$$<sup>th</sup> sample data of the waveform
