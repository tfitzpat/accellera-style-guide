...
1.  The `constant-width` font is used for all other code; primarily:
...
the case of a *warning*, the *implementation shall call* report with a severity of `SC_WARNING`. See [5.8](#58-error-reporting) for details of **`cci_report_handler`**.
