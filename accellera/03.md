...
# 3. Document authoring and formatting {#document-authoring-and-formatting}
{:.page-break-before}

This chapter explains the document authoring and formatting.

## 3.1 Use of Markdown and Kramdown syntax {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax}
...
### 3.1.1 Paragraphs {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-paragraphs}
...
### 3.1.2 Headers {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-headers}
...
### 3.1.3 Italics {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-italics}
...
### 3.1.4 Bold {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-bold}
...
### 3.1.5 Lists {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-lists}

#### 3.1.5.1 Unordered lists {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-lists-unordered-lists}
...
#### 3.1.5.2 Ordered lists {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-lists-ordered-lists}
...
### 3.1.6 Tables {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-tables}

#### 3.1.6.1 Simple table using Markdown format {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-tables-simple-table-using-markdown-format}
...
#### 3.1.6.2 Complex tables using HTML format {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-tables-complex-tables-using-html-format}
...
### 3.1.7 Code blocks {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-code-blocks}
...
### 3.1.8 Inline code {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-inline-code}
...
### 3.1.9 Footnotes {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-footnotes}
...
### 3.1.10 Links and references {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-links-and-references}

#### 3.1.10.1 External links (URLs) {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-links-and-references-external-links-urls}
...
#### 3.1.10.2 Internal links / references {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-links-and-references-internal-links-references}
...
### 3.1.11 Images {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-images}
...
### 3.1.12 HTML entities and Unicode characters {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-html-entities-and-unicode-characters}
...
### 3.1.13 HTML attributes {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-html-attributes}
...
### 3.1.14 Page breaks {#document-authoring-and-formatting-use-of-markdown-and-kramdown-syntax-page-breaks}
