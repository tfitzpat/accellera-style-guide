...
[Equation 1](equation-1) shows the embedding of a MathML equation stored in a separate XML file. [Equation 1](equation-1)
...
| Note | `.note` | Block | Create a paragraph describing a note. According to the style manual, notes use a smaller font size. 
Place `{:.note}` at the start of the paragraph. |
