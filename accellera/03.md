...
# 3. Document authoring and formatting {#pcngzoi}
{:.page-break-before}

This chapter explains the document authoring and formatting.

## 3.1 Use of Markdown and Kramdown syntax {#jgisstq}
...
By default, Kramdown will automatically create an ID for each header, such that it can be referenced (see also [3.1.10](#qceldte)). Kramdown supports the definition of a user defined ID as shown below. Note that in this case, the user should reference to this user-defined ID when creating the table of contents, or when creating a cross-reference.
...
#### 3.1.5.1 Unordered lists {#kpgqerx}
...
### 3.1.6 Tables {#rnazivs}

#### 3.1.6.1 Simple table using Markdown format {#qxkfypl}
...
"
   reference="wvmtpmw"
   caption="Table 3&mdash;This is the table caption"
   alt-text=""
...
#### 3.1.6.2 Complex tables using HTML format {#xmxmesm}
...
<table>
  ...
  <tr>
   ...
   reference="xbidgia"
   caption="Table 4&mdash;This is the a more complex table with merged rows and columns"
   alt-text=""
   class="fixed allow-break"
   caption-position="top"
%}
...
<table>
  ...
  <tr>
   ...
   reference="xbidgia"
   caption="Table 4&mdash;This is the a more complex table with merged cells and columns"
   alt-text=""
   class="fixed allow-break"
   caption-position="top"
%}
...
### 3.1.10 Links and references {#qceldte}

#### 3.1.10.1 External links (URLs) {#tqpjqoo}
...
#### 3.1.10.2 Internal links / references {#ncsesnv}
...
{&#x25; include figure
   ...
   caption="Figure 1-1&mdash;Accellera logo as PNG"
   alt-text=""
   class="fixed"
&#x25;}
</code></pre>
...
### 3.1.12 HTML entities and Unicode characters {#lnkjwkn}
...
<table>
  ...
  <tr>
   ...
   reference="lemkhot"
   caption="Table 7&mdash;HTML entities and Unicode characters"
   alt-text=""
   class="fixed"
   caption-position="top"
%}

### 3.1.13 HTML attributes {#rrdbtnt}
