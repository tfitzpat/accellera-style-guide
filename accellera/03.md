...
The example below shows the embedding of a MathML equation stored in a separate XML file.
...
Equations in LaTex syntax are also supported, see the example below.
