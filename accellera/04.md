...
### 4.1.1 Front cover page {#hfdbyfa}
...
If applicable, an acknowledgments section can be added to recognize specific contributions of individuals or organizations. In case an introduction section is given, it is recommended to add the acknowledgments section on the introduction page (see [4.1.4](#bryykkh)). 
...
### 4.1.4 Introduction page {#bryykkh}
...
The introduction page may contain an acknowledgments section (see [4.1.3](#yecvick)).

### 4.1.5 Notice page {#musiryb}
...
### 4.1.6 Participants page {#jmnbuew}
...
### 4.1.7 Table of contents {#tgijufn}
...
### 4.2.2 Normative references {#mzxitum}
...
### 4.2.3 Definitions, acronyms, and abbreviations {#pqlatcv}
...
### 4.2.4 Numbering clauses and subclauses {#ycwwnwc}
...
#### 4.3.1.2 Normative and Informative annexes {#yqctrbj}
...
#### 4.3.1.3 Bibliography, glossary {#lyfcoue}
...
### 4.3.4 Headers and footers {#zethnnj}
